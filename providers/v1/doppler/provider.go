...
func init() {
	...
	fs.IntVar(
		...
		"Maximum size of Doppler ETag-based secrets cache. This cache stores secret "+
			"values to reduce API calls when secrets haven't changed. Set to 0 to disable caching.")
