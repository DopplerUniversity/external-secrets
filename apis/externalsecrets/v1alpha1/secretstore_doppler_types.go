...
// Set DOPPLER_API_HOST and DOPPLER_API_VERIFY_TLS environment variables to override defaults
...
type DopplerProvider struct {
	...
	// Environment variable compatible name transforms that change secret names to a different format (e.g. camelCase)
	...
	// +kubebuilder:validation:Enum=json;env;env-no-quotes;docker;dotnet-json;java-spring-properties;yaml
	// +optional
	Format string `json:"format,omitempty"`

	// Whether dynamic secrets should be included
	// +optional
	IncludeDynamicSecrets bool `json:"includeDynamicSecrets,omitempty"`

	// Whether dynamic secrets should be included
	// +kubebuilder:default=1800
	// +optional
	DynamicSecretsTTL int32 `json:"dynamicSecretsTTL,omitempty"`
}
